window.addEventListener('load', function () {
    ...
    setTimeout(() => {
        ...
        th_name_fillter_link.addEventListener("click", function () {
            // Получаем текущее значение атрибута
            var currentValue = th_name_fillter_link.getAttribute("data-value");

            // Проверяем текущее значение и изменяем на противоположное
            if (currentValue === "true") {
                th_name_fillter_link.setAttribute("data-value", "true");
            } else {
                th_name_fillter_link.setAttribute("data-value", "false");
            }
        });
